    ...
    return (
        <div className="pop-up" style={{ position: "fixed", bottom: 56, left: showNotes ? 326 : 14, width: 230, background: "#FFF", border: `1px solid ${BORDER}`, borderRadius: 16, boxShadow: "0 16px 40px rgba(0,0,0,.12)", zIndex: 100, overflow: "hidden" }}>
            ...
            <div style={{ padding: 14, textAlign: "center" }}>
                <div style={{ fontFamily: "'Nunito',sans-serif", fontWeight: 900, fontSize: 46, letterSpacing: "-1px", color: timerSecs < 60 ? "#EF4444" : timerSecs < 120 ? "#F97316" : "#8B5CF6", lineHeight: 1, marginBottom: isHost ? 12 : 0 }}>
                ...
                {isHost && (
                    <>
                        ...
                        <div style={{ display: "flex", gap: 7, justifyContent: "center" }}>
                            <button onClick={timerRunning ? onPause : onStart}
